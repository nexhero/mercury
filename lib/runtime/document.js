...
export const DocumentProvider = ({children})=>{
  ...
  return html`
<${DocumentContext.Provider} value=${{documentList,tagList,listAllDocuments, newDocument,openedDocuments,openDocument,deleteDocument,deleteTag,closeDocument,closeAllNotes}}>
  ${children}
<//>
`
}
