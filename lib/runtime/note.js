...
export const DocumentProvider = ({children})=>{
  ...
  const save = (map_key)=>{
    return new Promise(async(resolve,reject)=>{
      ...
      try {
        // console.log(openedDocuments.get(map_key))
  ...
  return html`
<${DocumentContext.Provider} value=${{documentList,listAllDocuments, newDocument,openedDocuments,openNote,save, duplicate,remove,closeNote,closeAllNotes}}>
  ${children}
<//>
`
}
