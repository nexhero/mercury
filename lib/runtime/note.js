...
export const DocumentProvider = ({children})=>{
  ...
  return html`
<${DocumentContext.Provider} value=${{documentList,tagList,listAllDocuments, newDocument,openedDocuments,openDocument,save, duplicate,deleteDocument,closeNote,closeAllNotes}}>
  ${children}
<//>
`
}
